          ...
          <Route path="/" element={
            <div className="card text-center">
              <div className="card-body">
                ...
                <NavLink to="/leaderboard" className="btn btn-success m-2">Leaderboard</NavLink>
                <NavLink to="/teams" className="btn btn-info m-2">Teams</NavLink>
                <NavLink to="/users" className="btn btn-warning m-2">Users</NavLink>
                <NavLink to="/workouts" className="btn btn-danger m-2">Workouts</NavLink>
              </div>
            </div>
          } />
        </Routes>
